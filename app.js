...
mongoose.connect('mongodb+srv://zedthekiller2003:khoabill2016@cluster0.pys1oqr.mongodb.net/?retryWrites=true&w=majority', { useNewUrlParser: true, useUnifiedTopology: true })
  .then(() => {
